            ...
            fn path_parameter(
                ...
                Ok(okapi::openapi3::Parameter {
                    ...
                    value: okapi::openapi3::ParameterValue::Schema {
                        ...
                        schema: schemars::schema::SchemaObject::new_ref(String::from(format!(
                            "#/components/schemas/{}",
                            $schema
                        ))),
                        example: None,
        ...
        impl serde::ser::Serialize for $name {
                ...
                S: serde::ser::Serializer,
            {
                serializer.serialize_str(
                    base64::encode_config(self.as_slice(), base64::URL_SAFE).as_str(),
                )
            }
        }
                ...
                D: serde::de::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for Base64Visitor {
                    ...
                    where
                        E: serde::de::Error,
                    {
                        let bytes_vec = base64::decode_config(v, base64::URL_SAFE)
